...
import com.cydeo.pages.WebTableCydeoLoginPage;
...
public class WebTable_StepDefinitions {
    ...
    WebTableCydeoLoginPage loginpage = new WebTableCydeoLoginPage();
    ...
    @When("users click to login button")
    public void users_click_to_login_button() {
        loginpage.loginButton.click();

    }
    @Then("users should see orders word in the URL")
    public void users_should_see_orders_word_in_the_url() {
    ...
    public void userEnterBelowCorrectCredentials(Map<String,String>credentials) {
    ...
    public void userEntersQuantity(String quantity) {
        ...
        //orderPage.inputQuantity.sendKeys(Keys.BACK_SPACE); temizlemek icin box ikiside olur
